...
import { l as loginFn, g as getGoogleAuthUrlFn } from "./router-DDxkyDS4.js";
import "../server.js";
...
function LoginPage() {
  ...
  return /* @__PURE__ */ jsx("div", { className: "min-h-screen flex items-center justify-center vpn-page-bg px-6", children: /* @__PURE__ */ jsxs("div", { className: "w-full max-w-md p-8 rounded-2xl border bg-card shadow-card-glow", children: [
    ...
    /* @__PURE__ */ jsxs("form", { className: "mt-6 space-y-4", onSubmit: handleSubmit, children: [
      ...
      error && /* @__PURE__ */ jsxs("div", { className: "text-sm text-destructive bg-destructive/10 rounded-lg px-3 py-2 space-y-1", children: [
        /* @__PURE__ */ jsx("p", { children: error }),
        error === "Неверный email или пароль" && /* @__PURE__ */ jsx(Link, { to: "/forgot-password", className: "inline-block text-destructive underline underline-offset-2 hover:opacity-80", children: "Забыли пароль?" })
      ] }),
